...
export const UserInsuranceContextProvider: React.FC<
  UserInsuranceContextProviderProps
> = ({ children }) => {
  ...
  return (
    <UserInsuranceContext.Provider
      value={{ user, updateUser, selectedPlan, updateSelectedPlan }}
    >
      {children}
    </UserInsuranceContext.Provider>
  );
...
export const UserInsuranceContext =
  createContext<UserInsuranceContextValues>(initialValues);
